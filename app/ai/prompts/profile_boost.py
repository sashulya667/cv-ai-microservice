...
- Формат text — Markdown:
  · каждый пункт с новой строки, начинай с маркера `- ` или нумерации `1. ` `2. ` …
  · **жирный** — для ключевых результатов, метрик, инструментов, технологий
  · *курсив* — редко, для уточнений (не злоупотребляй)
  · НЕ используй заголовки (#, ##), таблицы, HTML, горизонтальные линии, ссылки
